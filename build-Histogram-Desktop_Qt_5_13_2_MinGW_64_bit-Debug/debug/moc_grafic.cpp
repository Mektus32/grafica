...
QT_MOC_LITERAL(1, 8, 14), // "GraphicChanged"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 19), // "std::array<int,256>"
QT_MOC_LITERAL(4, 44, 10) // "ref_Values"

    },
    "Graphic\0GraphicChanged\0\0std::array<int,256>\0"
    "ref_Values"
};
...
void Graphic::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->GraphicChanged((*reinterpret_cast< const std::array<int,256>(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Graphic::*)(const std::array<int,256> & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Graphic::GraphicChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Graphic::GraphicChanged(const std::array<int,256> & _t1)
{
